		...
		<nav>
			...
			<div>
				<ul class='main-menu' style='float: left!important'>
					<a href="sanbong.php"><img style='padding: 10px 0 0 10px; height: 30px; width: 30px;' src="img/logo.png" alt="Logo"></a>
					<li><a href="sanbong.php">Sân bóng TTVHO</a></li>
				</ul>
			</div>
			...
			<div id="menu">
					...
					<div class="drop-menu">
						<ul class="main-menu">
							<li>
								...
								<ul class="sub-menu">
									<li><a class="hover" href="setting.php"> Cài đặt</a></li>
				...
				<?php if(isset($user['TenTK'])) { ?>
					<li><a class="hover" href="contact.php">Liên hệ</a></li>
					<li><a class="hover" href="sanbong.php">Sân bóng</a></li>	
					<li><a class="hover" href="status.php">Trạng thái</a></li>
					<li><a class="hover" href="sanyeuthicch.php">Yêu thích</a></li>
					<li><a class="hover" href="danhsachdat.php">Danh sách đặt</a></li>
				</ul>
				<?php 
				} else { ?>
					<li><a class="hover" href="status.php">Trạng thái</a></li>
